...
$work_history_array = array(
  ...
  "nextlesson" => array(
    ...
    "company" => "NextLesson",
    "url" => "nextlesson",
    "description" => "As Head of Design at NextLesson, I oversaw all artwork and website design needs. Originally hired to work with marketing and to create all the lesson covers on the site, I made interest icons for the InterestID tool, helped design the Interactive tool, and built a graphics library that freelancers could use to speed up artwork creation.",
