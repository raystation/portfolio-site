...
<?php 
 	...
 	function get_friendlist() {
 		array(
 			array("name" => "Peter Oumanski", "link" => "peteroumanski.com"),
 			array("name" => "Tim Eggert", "link" => "www.timeggert.com"),
...
<ul>
	<h5>Friend's List</h5>
	<li>Peter Oumanski</li>
	<li>http://marinagrinshpun.com</li>
	<li>tim eggert</li>
	<li>ami bogin</li>
	<li>mihae http://designtoandfro.com</li>
